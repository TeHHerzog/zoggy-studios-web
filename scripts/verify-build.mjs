...
const requiredSites = [
  {
    ...
    routes: [
      ...
      path.join("projects", "dark-fantasy-mmo", "index.html"),
      path.join("projects", "development-supervisor", "index.html"),
      path.join("projects", "groundmaker", "index.html"),
      path.join("projects", "monster-codex", "index.html"),
